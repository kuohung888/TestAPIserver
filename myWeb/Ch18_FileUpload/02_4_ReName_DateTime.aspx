<%@ Page Language="C#" AutoEventWireup="true" CodeFile="02_4_ReName_DateTime.aspx.cs" Inherits="Book_Sample_Ch18_FileUpload_02_3_ReName_DateTime" %>
...
<body>
    ...
    <div>
        ...
        <br />
        上傳成功以後，改用 <span class="auto-style1">DateTime 年月日時分秒 + 毫秒</span>當成檔名<br />
        <br />
        <h4>檔案上傳 ＃2-4(檔名重複的話，檔名改用DateTime當作檔名) :</h4>
        <p>
