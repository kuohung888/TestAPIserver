...
public partial class Book_Sample_Ch18_FileUpload_FileUpload_DB_Image_01 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.HasFile)
        {
            ...
            //改用 FileBytes屬性來做--  http://msdn.microsoft.com/zh-tw/library/system.web.ui.webcontrols.fileupload.filebytes(v=vs.110).aspx
            byte[] ImgByte = new byte[FileUpload1.PostedFile.ContentLength - 1];
            ImgByte =FileUpload1.FileBytes;
