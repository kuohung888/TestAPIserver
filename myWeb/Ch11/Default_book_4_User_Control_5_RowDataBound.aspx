<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default_book_4_User_Control_5_RowDataBound.aspx.cs" Inherits="Book_Sample_Ch11_Default_book_4_User_Control_5_RowDataBound" %>
...
<body>
    ...
    <div>
        <span class="style1">大腸包小腸 #3&nbsp;&nbsp;&nbsp; （單一GridView的Master-Detail功能）</span><span
            class="style3">寫在RowDataBound事件內</span><br />
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <RowStyle BackColor="#FFCCFF" ForeColor="#4A3C8C" />
            ...
            <HeaderStyle BackColor="#CC0000" Font-Bold="True" ForeColor="#F7F7F7" />
        </asp:GridView>
