<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default_book_4_User_Control_2_MSDN.aspx.cs" Inherits="Ch11_Default_book_4_User_Control_2_MSDN" %>


<!-- 以程式設計方式建立使用者控制項時，只有在您建立使用者控制項的 "強型別參考"後，
        ASP.NET Web 網頁才能使用它。 -->
<%@ Reference Control="Default_book_4_UserControl_2_MSDN.ascx" %>
