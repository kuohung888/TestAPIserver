<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GridView_RowDataBound_2.aspx.cs" Inherits="Book_Sample_Ch11_GridView_RowDataBound_2" %>
...
<body>
    ...
    <div>
        ...
        <br />
        GridView的 <span class="style1">RowDataBound事件 #2</span><br />
     ...
     =================================================<br />
     請參閱這篇文章，看看他錯在哪裡？ http://www.blueshop.com.tw/board/FUM20041006161839LRJ/BRD20140212190422L48.html
