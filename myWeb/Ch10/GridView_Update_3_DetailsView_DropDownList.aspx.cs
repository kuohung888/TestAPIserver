...
public partial class Book_Sample_Ch10_GridView_Update_3_DetailsView_DropDownList : System.Web.UI.Page
{
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select UnitPrice from Products where ProductID = " + DDL.SelectedValue  , Conn);
