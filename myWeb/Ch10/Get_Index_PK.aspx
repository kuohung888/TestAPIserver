...
<body>
    ...
    <div>
        ...
        重點--<span class="style2">GridView.<b>SelectedIndex</b> 與 GridView.<b>SelectedValue</b></span><br 
            ...
            class="style3"><b>ed</b>事件</span>裡面才行<br />
&nbsp;&nbsp;&nbsp; 如果寫在<strong><span class="auto-style1"> ing事件</span></strong>裡面，<br如果您把 GridView.SelectedIndex與 GridView.SelectedValue寫在其他事件（如GridView的 
        RowCommand()與 SelectedIndexChanging()事件內），在</span><span class="style4">第一次執行，都會衍生一些怪現象<br />
        <br />

        <br />
        重點--<span class="style1">在GridView1_RowCommand事件裡面，如何獲得這一列的資料表PK值？</span></div>
    </form>
