<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GridView_Page_CommandName_2_Error.aspx.cs" Inherits="Book_Sample_Ch10_GridView_Page_CommandName_2_Error" %>
...
<body>
    ...
    <div>
        自己設定「分頁」的 CommandName = &quot;Page&quot; <strong><span class="style3">#2</span></strong><br />
        ...
        <br />
        <strong><span class="style2">缺點：</span></strong><span class="style1">試圖解決上一個範例的缺點，但出現新的問題。<br />
            即使寫了程式，仍解不了？？？</span><br />
        <br />
        答案：<span class="auto-style1">因為程式放在</span><strong><span class="auto-style1">錯誤的「事件」</span></strong><span class="auto-style1">之中</span>。<br />
        <br />
