<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GridView_Delete_MultiRow_3_Page_Error.aspx.cs" Inherits="Book_Sample_Ch10_GridView_Delete_MultiRow_3_Page" %>
...
<body>
    ...
    <p>        批次刪除&nbsp; 多筆資料&nbsp;&nbsp; #3<strong><span class="style1">（分頁）</span></strong></p>
    <p>        <span class="style2">有錯誤！！當您點選 5, 15 ,25這幾筆記錄後，如果取消了 5這筆，會出現異常。</span></p>
    <p>
