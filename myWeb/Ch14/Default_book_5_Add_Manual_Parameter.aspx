<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default_book_5_Add_Manual_Parameter.aspx.cs" Inherits="Ch14_Default_book_5_Add_Manual_Parameter" %>
...
<body>
    ...
    <div>
        ...
        從資料庫連結開始，100%都用手寫程式<br />
        ASP.NET 2.0 ---- SqlDataSource版</span><span class="style1"> (參數InsertParameters)</span></strong><br />
        <br />
