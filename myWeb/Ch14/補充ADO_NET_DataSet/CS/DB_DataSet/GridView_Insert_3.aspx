<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GridView_Insert_3.aspx.cs" Inherits="Book_Sample_B09_Manual_Input_GridView_Insert_3" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>新增資料的幾種方法，#3</title>
    <style type="text/css">
        .style1
        {
            color: #006666;
...
<body>
    ...
    <div>
        ...
        <span class="style3">方法三：ADO.NET&nbsp; (<span class="style2">DataSet</span></span><span class="style1">)</span><br />
