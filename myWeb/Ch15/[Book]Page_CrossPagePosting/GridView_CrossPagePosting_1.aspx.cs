...
public partial class Book_Sample_Ch15__Book_Page_CrossPagePosting_GridView_CrossPagePosting_0 : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "myLINK")
        {
            ...
            Response.Redirect("GridView_CrossPagePosting_2.aspx?test_time=" + TB1.Text + "&title=" + TB2.Text);
