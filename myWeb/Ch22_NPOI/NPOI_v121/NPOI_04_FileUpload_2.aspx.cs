...
public partial class Book_Sample_Ch11_NOPI_04_FileUpload_2 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //-- 註解：先設定好檔案上傳的路徑
        //    網站上的目錄路徑。所以不寫磁碟名稱（不寫實體路徑）。
        String saveDir = "\\Book_Sample\\Ch11\\";
        //請先設定好這個目錄的存取權限，讓 IUSR帳號可以 [寫入]
