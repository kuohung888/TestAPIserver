...
public partial class Book_Sample_Ch11_NPOI_02_new_v124 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        u_Row.CreateCell(1).SetCellValue("6666");   //== .CreateCell() 可設定為同一列(Row)的 [第幾個格子]
        u_Row.CreateCell(2).SetCellValue("7777");
        u_Row.CreateCell(3).SetCellValue("8888");
        //**********************************************************(end)
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=EmptyWorkbook_2.xls");
