...
public partial class Book_Sample_Ch11_NPOI_v2131_Default_DB_03 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select top 20 id, test_time ,summary, author from test", Conn);
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=EmptyWorkbook_2007_3_DB.xlsx");
